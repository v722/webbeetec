...
exports.DbSetUp1661860035294 = void 0;
const moment = require("moment");
class DbSetUp1661860035294 {
    constructor() {
        this.name = 'DbSetUp1661860035294';
    }
    async up(queryRunner) {
        await queryRunner.query(`CREATE TABLE \`menu_items\` (\`id\` int NOT NULL AUTO_INCREMENT, \`name\` varchar(255) NOT NULL, \`url\` varchar(255) NOT NULL, \`parent_id\` int NULL, \`created_at\` datetime NOT NULL, \`updated_at\` datetime NOT NULL, PRIMARY KEY (\`id\`)) ENGINE=InnoDB`);
        await queryRunner.query(`CREATE TABLE \`workshops\` (\`id\` int NOT NULL AUTO_INCREMENT, \`start\` datetime NOT NULL, \`end\` datetime NOT NULL, \`event_id\` int NULL, \`name\` varchar(255) NOT NULL, \`created_at\` datetime NOT NULL, \`updated_at\` datetime NOT NULL, PRIMARY KEY (\`id\`)) ENGINE=InnoDB`);
        await queryRunner.query(`CREATE TABLE \`events\` (\`id\` int NOT NULL AUTO_INCREMENT, \`name\` varchar(255) NOT NULL, \`created_at\` datetime NOT NULL, \`updated_at\` datetime NOT NULL, PRIMARY KEY (\`id\`)) ENGINE=InnoDB`);
        ...
        await queryRunner.query(`INSERT INTO \`events\` (\`id\`, \`name\`, \`created_at\`, \`updated_at\`) VALUES
        ...
        await queryRunner.query(`INSERT INTO \`workshops\` (\`id\`, \`start\`, \`end\`, \`event_id\`, \`name\`, \`created_at\`, \`updated_at\`) VALUES
        (1, '` +
...
exports.DbSetUp1661860035294 = DbSetUp1661860035294;
